...
// Antd imports
import { Form, Button, Input, Row, Col, Image, Space, Modal, Typography } from "antd";
import { UserOutlined, UsergroupAddOutlined, PlayCircleOutlined } from "@ant-design/icons";
...
const LoginForm = ({ setAuthed }) => {
  ...
  return (
    ...
    <Row>
      <Col span={12}> 
        <Image preview={false} width={1300} height={800} src={"./robot_drone_login.jpg"}/>
      </Col>
      <Col span={12}>
        <Space direction="vertical" align="center" style={{marginLeft: 400}}>
          ...
          <Image preview={false} width={100} height={100} src={"./video.png"}/>
          <Button icon={<PlayCircleOutlined />} type="primary" onClick={() => setShowVideo(true)}>
              Play Demo
          </Button>
