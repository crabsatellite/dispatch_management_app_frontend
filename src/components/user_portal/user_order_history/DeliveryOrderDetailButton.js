...
// Project imports
import {
  FRONTEND_COURIER_NAME,
  FRONTEND_WAREHOUSE_NAME,
    ...
    <>
      ...
      >
        <Space direction="vertical">
          ...
          <Text type="secondary">
            {delivery.deliveryInfo.receiverPhoneNumber}
          </Text>
          ...
          <Text type="secondary">
            {FRONTEND_WAREHOUSE_NAME[
              delivery.deliveryInfo.warehouseId
            ].toLowerCase()}
          </Text>
          <Text strong={true}>"Dispatch Type"</Text>
          <Text type="secondary">
            {FRONTEND_COURIER_NAME[
              delivery.deliveryInfo.courierId
            ].toLowerCase()}
          </Text>
          ...
          <Text type="secondary">
            ...
            delivery.deliveryItem.length > 0 &&
            delivery.deliveryItem[0].items &&
            delivery.deliveryItem[0].items.length > 0
              ? delivery.deliveryItem[0].items[0].name
              : "N/A"}
          </Text>
          ...
          <Text type="secondary">
            ...
            delivery.deliveryItem[0].items &&
            delivery.deliveryItem[0].items.length > 0
              ? delivery.deliveryItem[0].items[0].quantity
              : "N/A"}
          </Text>
        </Space>
      </Modal>
